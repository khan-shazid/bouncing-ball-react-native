  ...
  return r.make((function(r) {
    ...
    Promise.resolve().then((function() {
      ...
      if ("AbortError" !== r.name) {
        var n = makeErrorResult(e, f ? new Error(l.statusText) : r, l);
        i(n);
        s();
      }
    }));
...
//# sourceMappingURL=4f228e75.js.map
